    ...
    public boolean verify_And_Get_Latest_Alert_Displayed_For_Strategies(String TextMessage , String TabNameToNavigate, Boolean GetUniqueStockList ) throws InterruptedException {
        ...
        try {
            ...
            if (!this.isText_Message_NoTriggersForThisAlertYet_Visible()) {
                ...
                }else if(TextMessage.contains(Constants.ST1_CONDITION_3_Step_3)){
                    default_Alert_Time_Stamp = Constants.ST1_Cndt_3_DEFAULT_ALERT_TIMESTAMP;
                }else if(TextMessage.contains(Constants.ST1_CONDITION_4_Step_4)){
                    default_Alert_Time_Stamp = Constants.ST1_Cndt_4_DEFAULT_ALERT_TIMESTAMP;
                }else if(TextMessage.contains(Constants.ST1_CONDITION_5_Step_5)){
                    default_Alert_Time_Stamp = Constants.ST1_Cndt_5_DEFAULT_ALERT_TIMESTAMP;       /// ST 1 ends
                ...
                }else if(TextMessage.contains(Constants.ST2_CONDITION_3_Step_3)){
                    default_Alert_Time_Stamp = Constants.ST2_Cndt_3_DEFAULT_ALERT_TIMESTAMP;        /// ST 2 Ends
                }else if(TextMessage.contains(Constants.ST2_CONDITION_4_Step_4)){
...
//                }
                ...
                if (DateTimeFunctions.compare_Date_Time(latest_Alert_TimeStamp,default_Alert_Time_Stamp)){
                    ...
                    if (TextMessage.contains(Constants.ST1_CONDITION_1_Step_1)){                       /// ST 1 Starts
                        ...
                        Constants.ST1_Cndt_3_DEFAULT_ALERT_TIMESTAMP = latest_Alert_TimeStamp;
                    }else if(TextMessage.contains(Constants.ST1_CONDITION_4_Step_4)) {
                        Constants.ST1_Cndt_4_DEFAULT_ALERT_TIMESTAMP = latest_Alert_TimeStamp;
                    }else if(TextMessage.contains(Constants.ST1_CONDITION_5_Step_5)) {
                        Constants.ST1_Cndt_5_DEFAULT_ALERT_TIMESTAMP = latest_Alert_TimeStamp;          /// ST 1 ends
                    }else if(TextMessage.contains(Constants.ST2_CONDITION_1_Step_1)) {                      /// ST 2 Starts
                        ...
                        Constants.ST2_Cndt_3_DEFAULT_ALERT_TIMESTAMP = latest_Alert_TimeStamp;
                    }else if(TextMessage.contains(Constants.ST2_CONDITION_4_Step_4)) {
